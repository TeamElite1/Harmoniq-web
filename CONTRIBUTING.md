...
1. Create a new branch for your work:
   ```sh
   git checkout -b feat/HARMONIQ-2145-your-feature-name
   ```
   ##### Branch Naming Rules
   ...
   - For any of these updates, you will likely use a ticket or an issue. The ticket number, e.g. HARMONIQ-2145 or issue number should also be included in your branch name
   - Finally, a short description for your update should follow suit. This is often taken from the ticket title
   - All of this (except the ticket number acronym, `HARMONIQ`) should be written in lowercase
     > Thus, a typical branch should look like `feat/HARMONIQ-1234-create-login-page` or like `chore/remove-unused-variables` if your update has no corresponding ticket or issue (unlikely)
